...
/**
 * Api services for the `Privilegjet` model.
 */
@Injectable()
export class PrivilegjetApi extends BaseLoopBackApi {
  ...
  /**
   * Queries principals of Privilegjet.
   *
   * @param {any} id Privilegjet id
   *
   * @param {object} filter 
  ...
  /**
   * Counts principals of Privilegjet.
   *
   * @param {any} id Privilegjet id
   *
  ...
  public countPrincipals(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Privilegjet/:id/principals/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
