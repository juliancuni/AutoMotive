...
export class MjetiApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for preventivet.
   *
   * @param {any} id Mjeti id
   *
   * @param {any} fk Foreign key for preventivet
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdPreventivet(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for preventivet.
   *
   * @param {any} id Mjeti id
   *
   * @param {any} fk Foreign key for preventivet
   ...
   * This method returns no data.
   */
  public destroyByIdPreventivet(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for preventivet.
   *
   * @param {any} id Mjeti id
   *
   * @param {any} fk Foreign key for preventivet
   ...
   * </em>
   */
  public updateByIdPreventivet(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet/:fk";
    let _routeParams: any = {
  ...
  /**
   * Queries urdheraDiagnoze of Mjeti.
   *
   * @param {any} id Mjeti id
   *
   * @param {object} filter 
  ...
  /**
   * Counts urdheraDiagnoze of Mjeti.
   *
   * @param {any} id Mjeti id
   *
  ...
  public countUrdheraDiagnoze(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/urdheraDiagnoze/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getPreventivet(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in preventivet of this model.
   *
   * @param {any} id Mjeti id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createPreventivet(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet";
    let _routeParams: any = {
  ...
  /**
   * Deletes all preventivet of this model.
   *
   * @param {any} id Mjeti id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deletePreventivet(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countPreventivet(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyPreventivet(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Mjetet/:id/preventivet";
    let _routeParams: any = {
