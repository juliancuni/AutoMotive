...
export class PerfaqesuesApi extends BaseLoopBackApi {
  ...
  public findByIdUrdheraDiagnoze(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Perfaqesuesit/:id/urdheraDiagnoze/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdUrdheraPune(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Perfaqesuesit/:id/urdheraPune/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries urdheraDiagnoze of Perfaqesues.
   *
   * @param {any} id Perfaqesues id
   *
   * @param {object} filter 
  ...
  public getUrdheraDiagnoze(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Perfaqesuesit/:id/urdheraDiagnoze";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts urdheraDiagnoze of Perfaqesues.
   *
   * @param {any} id Perfaqesues id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countUrdheraDiagnoze(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Perfaqesuesit/:id/urdheraDiagnoze/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries urdheraPune of Perfaqesues.
   *
   * @param {any} id Perfaqesues id
   *
   * @param {object} filter 
  ...
  /**
   * Counts urdheraPune of Perfaqesues.
   *
   * @param {any} id Perfaqesues id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countUrdheraPune(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Perfaqesuesit/:id/urdheraPune/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
