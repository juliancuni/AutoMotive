...
/**
 * Api services for the `PjeseKembimi` model.
 */
@Injectable()
export class PjeseKembimiApi extends BaseLoopBackApi {
  ...
  public linkUrdheraPune(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PjeseKembimi/:id/urdheraPune/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries urdheraPune of PjeseKembimi.
   *
   * @param {any} id PjeseKembimi id
   *
   * @param {object} filter 
  ...
  /**
   * Counts urdheraPune of PjeseKembimi.
   *
   * @param {any} id PjeseKembimi id
   *
  ...
  public countUrdheraPune(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PjeseKembimi/:id/urdheraPune/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
