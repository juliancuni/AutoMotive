...
export class LiberMjetiApi extends BaseLoopBackApi {
  ...
  public findByIdUrdheraDiagnoze(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LiberMjetis/:id/urdheraDiagnoze/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries urdheraDiagnoze of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
   * @param {object} filter 
  ...
  public getUrdheraDiagnoze(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LiberMjetis/:id/urdheraDiagnoze";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts urdheraDiagnoze of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
  ...
  public countUrdheraDiagnoze(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LiberMjetis/:id/urdheraDiagnoze/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries urdheraPune of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
   * @param {object} filter 
  ...
  /**
   * Counts urdheraPune of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countUrdheraPune(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LiberMjetis/:id/urdheraPune/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries preventivet of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
   * @param {object} filter 
  ...
  /**
   * Counts preventivet of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countPreventivet(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LiberMjetis/:id/preventivet/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries diagnozat of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
   * @param {object} filter 
  ...
  /**
   * Counts diagnozat of LiberMjeti.
   *
   * @param {any} id LiberMjeti id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countDiagnozat(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LiberMjetis/:id/diagnozat/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
