...
export class UrdherDiagnozeApi extends BaseLoopBackApi {
  ...
  public findByIdDiagnozat(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UrdheraDiagnoze/:id/diagnozat/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdPreventiva(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UrdheraDiagnoze/:id/preventiva/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries diagnozat of UrdherDiagnoze.
   *
   * @param {any} id UrdherDiagnoze id
   *
   * @param {object} filter 
  ...
  /**
   * Counts diagnozat of UrdherDiagnoze.
   *
   * @param {any} id UrdherDiagnoze id
   *
  ...
  public countDiagnozat(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UrdheraDiagnoze/:id/diagnozat/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries preventiva of UrdherDiagnoze.
   *
   * @param {any} id UrdherDiagnoze id
   *
   * @param {object} filter 
  ...
  /**
   * Counts preventiva of UrdherDiagnoze.
   *
   * @param {any} id UrdherDiagnoze id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countPreventiva(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UrdheraDiagnoze/:id/preventiva/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
