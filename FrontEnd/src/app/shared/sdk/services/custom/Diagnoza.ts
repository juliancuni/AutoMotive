...
/**
 * Api services for the `Diagnoza` model.
 */
@Injectable()
export class DiagnozaApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation kategoriSherbimesh.
   *
   * @param {any} id Diagnoza id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getKategoriSherbimesh(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
